            ...
            <div>
                ...
                @else
                    @if ($view === 'gallery')
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-10 items-start">
                    ...
                    @else
                        {{-- CARDS (default) --}}
                        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-8 gap-y-12 items-start">
                            @foreach ($artworks as $artwork)
                                <a href="{{ route('artworks.show', $artwork) }}" class="block group">
                                    @if ($artwork->primary_image)
                                        <div class="overflow-hidden bg-gray-50 flex items-center justify-center">
