...
namespace App\Filament\Resources\MediumResource\RelationManagers;
...
class ArtworksRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Artworks using this medium';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('No artworks use this medium yet.');
    }
}
